      ...
      <div sx={{background: 'linear-gradient(to right, #ebb745 0%, #dd8729 100%)', color: 'white', fontSize: 0, p: {my: 0}}}>
        <Container sx={{
          ...
          <div className='footerColumn' sx={{width: ['full', null, null, '1/5']}}>
            <p sx={{variant: 'text.superHeading', '::before': {borderTopColor: 'white'}, color: 'white'}}>About Us</p>
          ...
          <div className='footerColumn' sx={{
            ...
            <p sx={{variant: 'text.superHeading', '::before': {borderTopColor: 'white'}, color: 'white'}}>Contact Jimmy</p>
